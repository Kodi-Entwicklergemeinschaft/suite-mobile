...
import 'package:template_a/feat/bottom_navigation/data/repo_impl/bottom_navigation_repo_impl.dart';
...
class BottomNavigationUsecase implements BaseUseCase<BaseModel, BaseModel> {
  ...
  @override
  Future<Either<Exception, BaseModel>> call(BaseModel params) async {
