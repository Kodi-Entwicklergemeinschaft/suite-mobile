...
import 'package:template_a/feat/fav/data/repo_impl/remove_fav_repo_impl.dart';
...
class RemoveFavUseCase implements BaseUseCase<RemoveFavResponseModel, RemoveFavRequestModel> {
  final RemoveFavRepo repo;

  RemoveFavUseCase({required this.repo});

  @override
  Future<Either<Exception, RemoveFavResponseModel>> call(RemoveFavRequestModel params) {
