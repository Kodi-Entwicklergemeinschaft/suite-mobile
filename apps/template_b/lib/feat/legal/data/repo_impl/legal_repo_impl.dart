...
import 'package:template_b/feat/legal/data/service/legal_service.dart';
import 'package:template_b/feat/legal/domain/repo/legal_repo.dart';
...
class LegalRepoImpl implements LegalRepo {
  ...
  LegalRepoImpl({required LegalService legalService}) : _legalService = legalService;
