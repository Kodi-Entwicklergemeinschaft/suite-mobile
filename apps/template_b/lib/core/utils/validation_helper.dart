class ValidationHelper {
  ...
  // Name validation (letters, digits, spaces, hyphens, apostrophes, periods)
  ...
  static String? validatePhoneNumber(String? value) {
    ...
    // Remove common separators for validation (dots excluded — not valid in phone numbers)
  ...
  static String? validateWebsite(String? value) {
    ...
    // Normalize: prepend https:// if no protocol present so the regex stays simple
    final normalized = trimmed.startsWith(RegExp(r'https?://'))
        ? trimmed
        : 'https://$trimmed';
    // Accepts: https://..., http://..., www....., or plain domain (e.g. example.com)
